...
export default function DSUOmbudsman({ data }) {
                    ...
                    <div className="rtBx">
                        ...
                        <div className="w-full lg:h-full rounded-[10px] border border-black/10 p-[15px] md:p-[20px] lg:p-[25px] xl:p-[30px] 2xl:p-[35px] 3xl:p-[45px_55px]">
                            ...
                            <div className="flex flex-wrap w-full  max-sm:gap-[15px]">
                                                ...
                                                <Link href={`mailto:${data?.email}`} className="flex gap-[10px] group">
                                                    <div className="w-[18px] xl:w-[20px] 3xl:w-[22px] h-[18px] 2xl:w-[20px] 3xl:h-[22px] flex">
                                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <g clipPath="url(#clip0_6104_14910)">
                                ...
                                <div className="sm:w-[calc(100%-200px)] lg:w-[calc(100%-225px)] xl:w-[calc(100%-280px)] 2xl:w-[calc(100%-335px)] 3xl:w-[calc(100%-420px)]
                                    sm:pl-[20px] lg:pl-[25px]  2xl:pl-[30px] 3xl:pl-[40px]">
