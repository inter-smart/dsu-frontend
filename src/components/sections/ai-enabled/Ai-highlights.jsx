...
export default function AiHighlights({ data }) {
    return (
        <section className='relative py-[40px_10px] xl:py-[50px_10px] 2xl:py-[60px_10px] 3xl:py-[80px_20px] bg-white dark:py-[40px] dark:bg-[#0e0d0db5] transition-colors duration-300'>
