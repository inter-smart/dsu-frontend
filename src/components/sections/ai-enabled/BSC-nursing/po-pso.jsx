...
export default function PoPsoSection({ data }) {
    if (!data) return null;
            ...
            <div className="container">
                ...
                {data.po && (
                    <div className="mb-[50px] lg:mb-[70px]">
                        <h2 className="cmn_Title mb-[10px] xl:mb-[15px]">{data.po.heading}</h2>
                        <p className="text_1 dark:text-white mb-[30px] lg:mb-[40px]">{data.po.subtitle}</p>
                        ...
                        {data.po.button && (
                            <div className="mt-[30px] lg:mt-[40px]">
                                <Link
                                    href={data.po.button.href || "#"}
                                    className="group relative flex items-center gap-[20px] justify-between w-fit py-[15px] 2xl:py-[18px] 3xl:py-[22px]   dark:border-white/10 hover:text-[#DC2626] transition-colors duration-300 overflow-hidden hover:border-[#DC2626]/40"
                                >
                                    ...
                                    <div className="flex items-center justify-between gap-[15px] transition-transform duration-300 group-hover:translate-x-[6px]">
                                        ...
                                        <div className="text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[18px] text-black dark:text-white group-hover:text-[#DC2626]">{data.po.button.label}</div>
                                    </div>
                ...
                {/* Divider Line if needed, though image just shows spacing */}
                {(data.po && data.pso) && (
                    <div className="w-full h-[1px] bg-gray-200 dark:bg-white/10 mb-[50px] lg:mb-[70px]"></div>
                )}

                {/* Program Specific Outcomes (PSOs) */}
                {data.pso && (
                    <div>
                        <h2 className="cmn_Title mb-[10px] xl:mb-[15px]">{data.pso.heading}</h2>
                        <p className="text_1 text-[#4A5565] dark:text-white  mb-[30px] lg:mb-[40px]">{data.pso.subtitle}</p>

                        <div className="flex flex-col gap-[20px] lg:gap-[25px]">
                            {data.pso.items?.map((item, index) => (
                                <div key={index}>
                                    <h3 className="cmn_Txt mb-[5px] xl:mb-[10px]">{item.title}</h3>
                            ...
                            <div className="mt-[30px] lg:mt-[40px]">
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between gap-[15px] transition-transform duration-300 group-hover:translate-x-[6px]">
                                        ...
                                        <div className="text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[18px] text-black dark:text-white group-hover:text-[#DC2626]">{data.pso.button.label}</div>
                                    </div>
                                    <div className="w-[10px] 2xl:w-[18px] 3xl:w-[20px] h-[12px] 2xl:h-[15px] 3xl:h-[18px] flex group-hover:translate-x-[-6px] transition-transform duration-300">
                                        <svg width="20" height="18" className="[&_path]:fill-[#212121] dark:[&_path]:fill-white group-hover:[&_path]:fill-[#DC2626] transition-colors duration-300" viewBox="0 0 20 18" fill="none"  >
                                            <path d="M19.1973 7.80308L12.1519 0.330392C11.9508 0.117084 11.6827 0 11.3969 0C11.1108 0 10.8429 0.117252 10.6418 0.330392L10.0021 1.00901C9.80113 1.22198 9.69042 1.50645 9.69042 1.80976C9.69042 2.1129 9.80113 2.40695 10.0021 2.61993L14.1123 6.98888H1.05396C0.465202 6.98888 0 7.47774 0 8.10236V9.06174C0 9.68635 0.465202 10.2245 1.05396 10.2245H14.1589L10.0022 14.6179C9.80128 14.8312 9.69057 15.1079 9.69057 15.4112C9.69057 15.7142 9.80128 15.9949 10.0022 16.2081L10.6419 16.8845C10.843 17.0978 11.1109 17.2141 11.3971 17.2141C11.6829 17.2141 11.9509 17.0963 12.152 16.883L19.1975 9.41047C19.3991 9.19649 19.5099 8.91084 19.5091 8.6072C19.5098 8.30254 19.3991 8.01673 19.1973 7.80308Z" />
                ...
                {data.peo && (
                    <div>
                        <h2 className="cmn_Title mb-[10px] xl:mb-[15px]">{data.peo.heading}</h2>
                        <p className="text_1 text-[#4A5565] dark:text-white  mb-[30px] lg:mb-[40px]">{data.peo.subtitle}</p>

                        <div className="flex flex-col gap-[20px] lg:gap-[25px]">
                            {data.peo.items?.map((item, index) => (
                                <div key={index}>
                                    <h3 className="cmn_Txt mb-[5px] xl:mb-[10px]">{item.title}</h3>
                                    <p className="text_1">{item.description}</p>
                                </div>
                            ...
                            <div className="mt-[30px] lg:mt-[40px]">
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between gap-[15px] transition-transform duration-300 group-hover:translate-x-[6px]">
                                        ...
                                        <div className="text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[18px] text-black dark:text-white group-hover:text-[#DC2626]">{data.peo.button.label}</div>
                                    </div>
                                    <div className="w-[10px] 2xl:w-[18px] 3xl:w-[20px] h-[12px] 2xl:h-[15px] 3xl:h-[18px] flex group-hover:translate-x-[-6px] transition-transform duration-300">
                                        <svg width="20" height="18" className="[&_path]:fill-[#212121] dark:[&_path]:fill-white group-hover:[&_path]:fill-[#DC2626] transition-colors duration-300" viewBox="0 0 20 18" fill="none"  >
                                            <path d="M19.1973 7.80308L12.1519 0.330392C11.9508 0.117084 11.6827 0 11.3969 0C11.1108 0 10.8429 0.117252 10.6418 0.330392L10.0021 1.00901C9.80113 1.22198 9.69042 1.50645 9.69042 1.80976C9.69042 2.1129 9.80113 2.40695 10.0021 2.61993L14.1123 6.98888H1.05396C0.465202 6.98888 0 7.47774 0 8.10236V9.06174C0 9.68635 0.465202 10.2245 1.05396 10.2245H14.1589L10.0022 14.6179C9.80128 14.8312 9.69057 15.1079 9.69057 15.4112C9.69057 15.7142 9.80128 15.9949 10.0022 16.2081L10.6419 16.8845C10.843 17.0978 11.1109 17.2141 11.3971 17.2141C11.6829 17.2141 11.9509 17.0963 12.152 16.883L19.1975 9.41047C19.3991 9.19649 19.5099 8.91084 19.5091 8.6072C19.5098 8.30254 19.3991 8.01673 19.1973 7.80308Z" />
