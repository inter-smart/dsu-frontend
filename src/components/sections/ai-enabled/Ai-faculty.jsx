...
export default function AiFaculty({ data }) {
    ...
    // Support data.facultiesSection or data directly
    ...
    return (
        <section className="relative py-[35px] sm:py-[45px] lg:py-[60px] xl:py-[75px] bg-white dark:bg-[#0f1011] transition-colors duration-300">
            <div className="container">
                ...
                {categories.map((category, catIdx) => (
                    <div key={category.id || catIdx} className="mb-10 last:mb-0">
                        ...
                        {/* Faculty Grid - 4 columns matching image */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5 xl:gap-6">
                            {category.faculty?.map((member) => {
                                const profileHref = member.profileUrl || "#";

                                return (
                                    <div
                                        key={member.id}
                                        className="group relative bg-white dark:bg-[#18191B] border border-[#E7E1D8] dark:border-white/10 border-b-[5px] dark:border-b-[#F97316]/70 rounded-[10px] p-4 sm:p-[25px] flex flex-col justify-between shadow-[0_2px_8px_rgba(0,0,0,0.03)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.35)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_8px_25px_rgba(249,115,22,0.15)] hover:border-[#FDBA74]/60 dark:hover:border-[#F97316]/50 transition-all duration-300 hover:-translate-y-1"
                                    >
                                        <div>
                                            {/* Badge */}
                                        ...
                                        {/* Bottom Footer Section: Qualification + View Profile */}
                                        <div className="border-t border-[#F1F3F5] dark:border-white/10 mt-4 pt-3 flex gap-[10px] items-center justify-between text-[11px] sm:text-[11.5px] xl:text-[12px]">
                                            {/* Qualification */}
                                            ...
                                            >
                                                ...
                                                <svg width="15" height="13" className="ml-[5px] [&_path]:fill-[#212121] group-hover:[&_path]:fill-[#E05338]" viewBox="0 0 15 13" fill="none" >
