...
const sidebarMenu = [
    ...
    },
    {
        ...
        slug: "/ai-enabled/library/services",
    },
    {
        label: "Library Downloads",
        slug: "/ai-enabled/library/downloads",
    },
    {
        label: "Quick Abbreviations",
        slug: "/ai-enabled/library/abbreviations",
    },
    {
        label: "Library Automation",
        slug: "/ai-enabled/library/automation",
    },
    {
        label: "FAQ's",
        slug: "/ai-enabled/library/faqs",
    },
    {
        label: "Gallery",
        slug: "/ai-enabled/library/gallery",
    },
];

export default function LibrarySidebar({ isOpen = false, onClose, title = "DSU Act Menu" }) {
