                        ...
                        <div className="w-full lg:h-full rounded-[10px] border border-black/10 p-[15px] md:p-[20px] lg:p-[25px] xl:p-[35px_30px] 2xl:p-[40px_40px] 3xl:p-[50px]">
                            ...
                            {data?.files.map((item, id) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between gap-[15px] transition-transform duration-300 group-hover:translate-x-[6px]">
                                        <div className="w-[16px] xl:w-[18px] 2xl:w-[22px] 3xl:w-[30px] h-[12px] xl:h-[16px] 2xl:h-[18px] 3xl:h-[20px] flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                                            <svg width="24" height="33" className="[&_path]:fill-[#212121] dark:[&_path]:fill-white group-hover:[&_path]:fill-[#DC2626] transition-colors duration-300" viewBox="0 0 24 33" fill="none" >
                                        ...
                                        <div className="text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[20px] text-black dark:text-white group-hover:text-[#DC2626]">{item.label}</div>
