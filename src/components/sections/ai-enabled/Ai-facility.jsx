...
export default function AiFacility({ data }) {
    return (
        <section className="relative py-[35px] xl:py-[40px] 2xl:py-[60px] 3xl:py-[80px] text-white overflow-hidden  bg-gradient-to-b  from-[rgb(255,248,238,0.5)]  to-[rgba(255,243,224,0.5)]  dark:bg-gradient-to-r dark:from-[#383838b5] dark:to-[#383838b5] ">
                    ...
                    {data.labs.map((item, id) => (
                        <div className={`flex flex-wrap w-full   ${id % 2 === 0 ? "" : "lg: flex-row-reverse"}`} key={id}>
                            ...
                            <div className="w-full lg:w-1/2 flex items-center lg:py-[30px]">
                                ...
                                >
                                    <div className="text-[18px] lg:text-[24px] xl:text-[26px] 2xl:text-[32px] 3xl:text-[42px] font-bold text-[#212121] dark:text-white mb-[12px] sm:mb-[16px] 2xl:mb-[25px]">
                                        {item.title}
                                    </div>
                                    <p className="text_1">
                                        {item.description}
