  ...
  return (
    <section className="relative py-[40px] xl:py-[60px] 2xl:py-[80px] 3xl:py-[120px]">
      <div className="container">
        <div className="flex flex-wrap -m-[5px] lg:-m-[10px] 3xl:-m-[13px]">
          {data?.cards.map((item, id) => (
            <div className="w-full sm:w-1/2 md:w-1/3 p-[5px] lg:p-[10px] 3xl:p-[13px]" key={id}>
              <div className="relative w-full h-full group p-[15px] xl:p-[20px] 2xl:p-[25px] 3xl:p-[35px] border border-[#EFD8CA] rounded-[5px] xl:rounded-[10px] 2xl:rounded-[15px] 3xl:rounded-[20px]">
                ...
                <Link href="/" className="absolute top-[35px] right-[20px] opacity-0 group-hover:opacity-100 transition-all duration-100 hover:tracking-wider  text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[20px] flex items-center gap-[10px] bg-gradient-to-r from-[#DC2626] to-[#F97316] bg-clip-text text-transparent">
                  View
