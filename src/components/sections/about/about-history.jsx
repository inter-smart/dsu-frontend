                                ...
                                {data?.timeline.map((itemList, idx) => (
                                    <SwiperSlide key={idx} className="!h-auto relative before:absolute before:content-[''] before:left-[22px] before:xl:left-[27px] before:2xl:left-[32px] before:3xl:left-[40px] before:top-0 before:h-[calc(100%-40px)] before:bottom-0 before:m-auto before:-z-1 before:w-[1px] before:bg-black/20">
                                        <div className="w-full flex pb-[30px] xl:pb-[40px] 2xl:pb-[60px] 3xl:pb-[80px]">
                                            <div className="w-[45px] xl:w-[55px] 2xl:w-[65px] 3xl:w-[83px] h-[45px] xl:h-[55px] 2xl:h-[65px] 3xl:h-[85px] mt-[10px] bg-[#FFF8EE] rounded-full border border-[#FF6D00] p-[10px] 3xl:p-[20px]
                                            ...
                                            <div className="w-[calc(100%-45px)] xl:w-[calc(100%-55px)] 2xl:w-[calc(100%-65px)] 3xl:w-[calc(100%-85px)] pl-[15px] 2xl:pl-[25px] 3xl:pl-[32px]">
                    ...
                    <div className="w-full lg:w-1/3">
                        <div className="w-full">
                            ...
                            <Link href={data?.cta.url} className="text_1 font-bold capitalize flex items-center justify-center gap-[10px] 2xl:gap-[20px] text-white bg-gradient-to-r from-[#DC2626] to-[#F97316] w-fit 
                                    h-[30px] xl:h-[35px] 2xl:h-[40px] 3xl:h-[50px] min-w-[160px] xl:min-w-[155px] 2xl:min-w-[185px] 3xl:min-w-[230px] rounded-[6px] 2xl:rounded-[8px]">
                                {data?.cta.label}
                                <div className="w-[10px] h-[8px] flex items-center justify-center">
