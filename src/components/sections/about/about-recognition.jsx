                                        ...
                                        <div className="flex items-center justify-between py-[14px] 2xl:py-[12px] 3xl:py-[15px] border-b border-black/20 w-full" key={id}>
                                            <div className="flex items-center justify-between gap-[15px]">
                                                ...
                                                {(() => {
                                                    ...
                                                    const href = link?.linkType === "file" ? link?.file?.url : link?.url;
                                                    const label = link?.label;

                                                    return href ? (
                                                        <a
                                                            href={href}
                                                            target={link?.isExternal || link?.linkType === "file" ? "_blank" : undefined}
                                                            rel={link?.isExternal || link?.linkType === "file" ? "noopener noreferrer" : undefined}
                                                            className="text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[20px]"
                                                        >
                                                            {label}
                                                        </a>
                                                    ) : (
                                                        <div className="text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[20px]">{label}</div>
                                                    );
                                                })()}
                                                ...
                                                {firstList.map((data, id) => (
                                                    <div className="flex items-center justify-between  py-[14px] 2xl:py-[12px] 3xl:py-[15px] border-b border-black/20 " key={id}>
                                                        <div className="flex items-center justify-between gap-[15px]">
                                                            ...
                                                            <div className="text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[20px]">{data.link?.label}</div>
