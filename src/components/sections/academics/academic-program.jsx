                        ...
                        <div className="w-full sm:w-1/2" key={id}>
                            ...
                            {item.programs.map((program, idx) => (
                                <Link
                                    href={program?.url}
                                    key={idx}
                                    className="group flex items-center justify-between font-medium py-[15px] 2xl:py-[18px] 3xl:py-[22px] border-b border-black/20 px-0 lg:max-w-[80%] transition-colors duration-300"
                                >
