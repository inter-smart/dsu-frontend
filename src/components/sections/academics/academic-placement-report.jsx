                    ...
                    <div className="w-full lg:w-4/12">
                        ...
                        {data?.documents.map((item, id) => (
                            <Link
                                href={item?.file.url}
                                key={id}
                                className="group relative flex items-center justify-between py-[15px] 2xl:py-[18px] 3xl:py-[22px] border-b border-black/20 hover:text-[#DC2626] transition-colors duration-300 overflow-hidden hover:border-[#DC2626]/40"
                            >
                                ...
                                <div className="flex items-center justify-between gap-[15px] transition-transform duration-300 group-hover:translate-x-[6px]">
                                    <div className="w-[16px] xl:w-[18px] 2xl:w-[22px] 3xl:w-[30px] h-[12px] xl:h-[16px] 2xl:h-[18px] 3xl:h-[20px] flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                                        <svg width="24" height="33" className="[&_path]:fill-[#212121] group-hover:[&_path]:fill-[#DC2626] transition-colors duration-300" viewBox="0 0 24 33" fill="none" >
                                    ...
                                    <div className="text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[20px] text-black group-hover:text-[#DC2626]">{item.label}</div>
                                ...
                                <div className="w-[10px] 2xl:w-[18px] 3xl:w-[20px] h-[12px] 2xl:h-[15px] 3xl:h-[18px] flex group-hover:translate-x-[-6px] transition-transform duration-300">
                                    <svg width="20" height="18" className="[&_path]:fill-[#212121] group-hover:[&_path]:fill-[#DC2626] transition-colors duration-300" viewBox="0 0 20 18" fill="none"  >
