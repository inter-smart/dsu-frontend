    ...
    return (
        <section className="relative py-[40px_60px] xl:py-[55px_80px] 2xl:py-[65px_100px] 3xl:py-[75px_170px]">
            <div className="container">
                ...
                <div className="flex flex-wrap -m-[4px] md:-m-[5px] lg:-m-[7px] xl:-m-[10px] 3xl:-m-[15px]">
                    {data?.goals.map((item, id) => (
                        <div className="w-1/3 sm:w-1/4 lg:w-1/5 p-[4px] md:m-[5px] lg:p-[7px] xl:p-[10px] 3xl:p-[15px]" key={id}>
