          ...
          >
            {data.tabs.map((tab) => (
              <TabsTrigger
                key={tab.id}
                value={tab.value}
                className="gap-[20px] 2xl:gap-[25px] 3xl:gap-[30px] after:bg-linear-to-r after:from-[#DC2626] after:to-[#F97316] after:!h-1.5 3xl:after:!h-2 hover:after:opacity-10"
              >
                <div className="size-[60px] 2xl:size-[75px] 3xl:size-[94px] bg-white rounded-full flex items-center justify-center border border-[#F97316]/50">
                  {tab.trigger.icon && (
                    <Image
