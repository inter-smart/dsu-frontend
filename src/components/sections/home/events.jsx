    ...
    <section className="w-full h-auto py-[30px_50px] sm:py-[40px_50px] lg:py-[50px_60px] 2xl:py-[60px_70px] 3xl:py-[70px_90px] bg-white border-b border-[#0B214833] block">
      <div className="container">
        <div className="w-full h-auto mb-5 sm:mb-10 lg:mb-12.5 2xl:mb-15 3xl:mb-20 sm:text-center">
          <div className="text-[31px] xl:text-[36px] 2xl:text-[44px] 3xl:text-[55px] leading-normal font-bold text-[#212121] mb-1.25 xl:mb-2.5 3xl:mb-3.75">
            {data?.title}
          </div>
          <div className="text-[14px] 2xl:text-[16px] 3xl:text-[18px] leading-normal font-normal text-[#4A5565]">
            {data?.description}
          </div>
        </div>
          ...
          <div className="w-(--width) max-lg:pb-6.25 max-lg:mb-7.5 max-lg:border-b max-lg:border-black/10">
            <div className="w-full h-auto mb-2.5 2xl:mb-3.75 3xl:mb-5 hidden sm:flex items-center flex-wrap justify-between">
              <div className="flex items-center">
                <div className="text-[28px] sm:text-[22px] lg:text-[26px] 2xl:text-[32px] 3xl:text-[40px] leading-[1.2] font-bold text-[#212121] pr-2.5 2xl:pr-3.75 3xl:pr-5">
                  Latest Happenings
                </div>
              ...
              <div>
                <Link
                  href="#!"
                  className="text-[14px] 3xl:text-[16px] leading-normal font-bold uppercase bg-gradient-to-r from-[#DC2626] to-[#F97316] bg-clip-text text-transparent w-fit"
                >
                  View All
                </Link>
              </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="w-[calc(100%-var(--image-size))] h-auto pl-2.5 2xl:pl-3.75 flex flex-col justify-between py-1">
                        ...
                        <Link
                          href={item?.link}
                          className="text-[14px] leading-normal font-bold uppercase bg-gradient-to-r from-[#DC2626] to-[#F97316] bg-clip-text text-transparent w-fit"
                        >
                          Read More &gt;
                        </Link>
                      </div>
