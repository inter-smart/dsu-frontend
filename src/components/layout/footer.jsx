          ...
          <div className="flex flex-col gap-4 mb-6 lg:hidden">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="flex flex-col text-black">
                <span className="text-base font-serif leading-tight">
                  DAYANANDA SAGAR
                </span>
                <span className="text-lg font-serif font-bold tracking-widest leading-tight">
                  UNIVERSITY
                </span>
              </div>
            </Link>
          ...
          <div className="lg:hidden">
            ...
            <div className="grid grid-cols-2 gap-4 border-b border-gray-200 pb-5 mb-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <h4 className="text-[#f05c2a] font-bold text-xs mt-3 mb-1">
                  INTERNATIONAL ADMISSIONS
                </h4>
                <p className="text-black text-xs font-medium">
            ...
            <div className="border-b border-gray-200 pb-5 mb-5">
              ...
              <p className="text-black text-xs font-medium leading-relaxed">
                Administrative &amp; Main Admission office, Kudlu Gate, Hosur
                Road, Bengaluru - 560 114
              </p>
              <p className="text-black text-xs font-medium mt-2">
                E-mail: admissions@dsu.edu.in | dsat@dsu.edu.in
              </p>
              <p className="text-black text-xs font-medium">
                Admissions Helpline: 080 46461800 / 080 49092800 / +91
                7760964277 / 8296316737 / 6366885507
              </p>
              <p className="text-black text-xs font-medium">
                Office of Registrar: 080 4909 2910 / 11
              </p>
              ...
              <p className="text-black text-xs font-medium mt-1">
                Dean - MBA: 080 4909 2931
              </p>
              <p className="text-black text-xs font-medium">
                Enquiry EMBA: 080 4909 2930
            ...
            <div>
              ...
              <p className="text-black text-xs font-medium leading-relaxed">
                Gate 2, 6th Floor, University Building, Dental Block,
