    ...
    subheading: [
      {
        ...
        children: [
          {
            type: "text",
            text: "Access all official regulatory, accreditation and Statutory documents",
          },
        ],
      },
    ],
    ...
    timeline: [
      {
        period: "1960s–2000s",
        description:
          "The Dayananda Sagar Institutions (DSI) expanded rapidly across multiple disciplines including Engineering, Management, Medical Sciences, & Arts.",
      },
      {
        period: "2012",
        description:
          "The Karnataka Government passed the Dayananda Sagar University Act, paving the way for the university's establishment",
      },
      {
        period: "2014",
        description:
          "Dayananda Sagar University was officially established as a private university in",
      },
      {
        period: "2020",
        description:
          "DSU strengthened its focus on innovation, research, entrepreneurship, and global collaborations, emerging as a modern technology-driven university.",
      },
      {
        period: "2025",
        description:
          "DSU continues to grow as a premier institution known for industry-oriented education, advanced infrastructure, research excellence, and global learning opportunities.",
      },
    ],
    media: {
      url: "/images/about/about-history.jpg",
      alternativeText:
        "Aerial view of Dayananda Sagar University campus building",
    },
    heading: "Our History",
    description: [
      {
        ...
        children: [
          {
            type: "text",
            text: "Dayananda Sagar University (DSU), inspired by Late Sri R. Dayananda Sagar, is a top multidisciplinary university in Bengaluru. Since the 1960s, it has blended innovation, research, and industry-focused education to prepare leaders in engineering, management, healthcare, and tech.",
          },
        ],
      },
    ],
